...
public class VillagerCraftingRecipeCategory implements IRecipeCategory<VillagerCrafingRecipeWrapper> {
    private final IDrawable background;
    private final String title;
    private final IDrawable arrow;

    public VillagerCraftingRecipeCategory(IGuiHelper guiHelper) {
        title = I18n.format("millenairejei.villagercrafting.tabtitle");
